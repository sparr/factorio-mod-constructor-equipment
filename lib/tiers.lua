...
for level, spec in ipairs(DEFINED) do
  ...
  local tier = {
    ...
    --- the inserter it borrows from, unscaled. There was a discount here, worked out from
    --- how much of a bulk inserter's load this one carried, and it was built on a pair of
    --- wrong numbers -- a bulk inserter does not carry a fixed twelve, and nor does this.
